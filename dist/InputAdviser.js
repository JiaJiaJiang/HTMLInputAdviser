(function (global, factory) {
   ...
   * @class InputAdviser
   */var InputAdviser = /*#__PURE__*/function () {
    /**
     ...
     */
    function InputAdviser(input, loader) {
      var _this = this;
      _classCallCheck(this, InputAdviser);
            ...
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 5:
                    _this.setList(list, list.descList);
                  case 6:
                  case "end":
     ...
     */
    _createClass(InputAdviser, [{
      key: "setList",
      value: function setList(list, descList) {
